              ...
              <div class="row gap-y">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{asset('image/thumb/1.jpg')}}" alt="Card image cap"></a>
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{asset('image/thumb/2.jpg')}}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{asset('image/thumb/3.jpg')}}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{asset('image/thumb/4.jpg')}}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{asset('image/thumb/5.jpg')}}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{asset('image/thumb/6.jpg')}}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
