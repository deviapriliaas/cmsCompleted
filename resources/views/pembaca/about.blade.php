            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="fa fa-home" aria-hidden="true"></i>Beranda</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                        ...
                        <p>Orstyle.id adalah media fashion dimana menyajikan berbagai inspirasi terkait fashion.</p>
                        <p>Tidak hanya bergaya tetapi juga ikut menginspirasi dengan apik, bukan gosip</p>
                    
                        <img class="mt-15" src="{{asset('image/banner.png')}}" alt="">
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="{{asset('mag/img/bg-img/36.jpg')}}" alt="">
                            ...
                            <div class="team-member-content">
                                <h6>Devi Aprilia Ayu Santoso</h6>
                                <span>Owner</span>
                                <p>Titik dan Koma, berhenti jika menurutmu itu benar</p>
                            </div>
                        </div>
